    ...
    <div className={`flex flex-col gap-2 ${className}`}>
      ...
      >
        ...
        >
          ...
          <span className="absolute inset-x-2.5 bottom-2.5 font-display text-[15px] font-semibold leading-tight text-marfim">
            {title.name}
          </span>
        </button>

        {title.new && (
          <span className="pointer-events-none absolute left-2 top-2 rounded-md bg-ambar px-1.5 py-0.5 text-[10px] font-semibold text-breu">
            Novo
          </span>
        )}
